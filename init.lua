...
--
-- Keybinds to to go to normal mode from insert mode
vim.keymap.set('i', 'jk', '<Esc>', { desc = 'Toggle insert mode to normal mode' })

vim.keymap.set('i', '<Esc>', '<Esc>', { noremap = true, silent = true })

-- Keybinds to save in different modes
...
-- Keybinds to make ; enter the command mode
...
require('lazy').setup({
...

  {
    ...
    build = ':TSUpdate',
    config = function()
      -- Try the new 0.12 setup first, fallback to old if necessary
      local ts = require 'nvim-treesitter'

      ts.setup {
        ensure_installed = { 'go', 'lua', 'markdown', 'vim', 'vimdoc', 'html', 'javascript', 'typescript', 'c', 'cpp' },
        highlight = {
          enable = true,
      ...
      -- This is the manual command you ran, automated for every file
